...
const (
	ProductsService_Batch_FullMethodName = "/products.v1.ProductsService/Batch"
)
...
type ProductsServiceClient interface {
	Batch(ctx context.Context, in *BatchProductsRequest, opts ...grpc.CallOption) (*BatchProductsResponse, error)
}
...
func (c *productsServiceClient) Batch(ctx context.Context, in *BatchProductsRequest, opts ...grpc.CallOption) (*BatchProductsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(BatchProductsResponse)
	err := c.cc.Invoke(ctx, ProductsService_Batch_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ProductsServiceServer interface {
	Batch(context.Context, *BatchProductsRequest) (*BatchProductsResponse, error)
...
func (UnimplementedProductsServiceServer) Batch(context.Context, *BatchProductsRequest) (*BatchProductsResponse, error) {
...
func _ProductsService_Batch_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(BatchProductsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ProductsServiceServer).Batch(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ProductsService_Batch_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProductsServiceServer).Batch(ctx, req.(*BatchProductsRequest))
	}
...
var ProductsService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Batch",
			Handler:    _ProductsService_Batch_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "shared/contracts/proto/products.proto",
}
